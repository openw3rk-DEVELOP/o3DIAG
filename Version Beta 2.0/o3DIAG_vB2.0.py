...
\___/ .__/\__/_//_/__,__/____/_/ /_/\_\  /___/_/|_/ |___/___/_/|_/ /_/    
   /_/ o3DIAG Beta 2.0 - https://o3diag.openw3rk.de | https://openw3rk.de      
--------------------------------------------------------------------------
...
"""
    ...
    def __init__(self, root):
        self.root = root
        root.title("o3DIAG (version Beta 2.0) (for OBD / ELM327)")
    ...
    def load_dtc_map(self):
        ...
        try:
            ...
            self.log(f"P-Code list could not be read, syntax error?: {e}")
            self.dtc_map = {}
            return

        self.dtc_map = new_map
        self.log(f"P-Code list loaded: {len(self.dtc_map)} lines")
